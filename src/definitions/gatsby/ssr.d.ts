...
interface OnRenderBody {
  ...
  setHtmlAttributes(attributes: Record<string, unknown>): void; // attributes which will spread into <html>
  setBodyAttributes(attributes: Record<string, unknown>): void; // attributes which will spread into <body>
  ...
  setBodyProps(props: Record<string, unknown>): void; // props which will supplied to bodyProps of the gatsby's body
}
